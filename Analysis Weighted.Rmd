...
```{r}
df.scaled <- test.df[, c("chr_num", "pos", "mutated", "SNM", "INDEL", "ref.type", "CDS", "rep.strand", "collision", "tr.strand", "net_tot", "rep.ratio")]
...
# df.scaled$rep.ratio <- test.df$rep.ratio
...
```{r}
write.csv(df.scaled, "processed_data/weighted.csv")
```
...
(Intercept)                 -8.682e+00  1.244e-01 -69.799   <2e-16 ***
net_tot                      3.910e-06  2.046e-05   0.191   0.8484    
rep.ratio                   -6.815e-02  8.980e-02  -0.759   0.4479    
collision                    6.319e-01  3.355e-01   1.883   0.0597 .  
CDS                         -4.817e-02  5.014e-01  -0.096   0.9235    
net_tot:rep.ratio            2.169e-06  1.379e-05   0.157   0.8750    
net_tot:collision           -2.453e-05  5.234e-05  -0.469   0.6393    
rep.ratio:collision         -3.761e-01  2.414e-01  -1.558   0.1192    
net_tot:rep.ratio:collision  2.924e-06  3.602e-05   0.081   0.9353    
---
...
```{r}
mod <- glm(SNM ~ net_tot + rep.ratio * collision, family = "binomial", df.scaled)
summary(mod)
```
