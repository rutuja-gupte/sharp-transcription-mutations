...
net.plus <- read.csv("data/test_plus.csv")
net.minus <- read.csv("data/test_minus.csv")
...
write.csv(net.plus, "test_plus_sites.csv")
write.csv(net.minus, "test_minus_sites.csv")
