...
(Intercept)             -9.87692    6.71969  -1.470  0.14160    
ref.typeG/C              1.01517    0.04801  21.145  < 2e-16 ***
collision               -1.41944   14.84967  -0.096  0.92385    
net_tot                 -3.14988   32.85371  -0.096  0.92362    
CDS                     -9.33235   97.29496  -0.096  0.92359    
rep.ratio               -0.07449    0.02509  -2.969  0.00299 ** 
rep.strand               0.06867    0.02495   2.753  0.00591 ** 
collision:net_tot       -6.92877   72.60359  -0.095  0.92397    
collision:CDS          -20.51412  215.01271  -0.095  0.92399    
net_tot:CDS            -45.42740  475.69894  -0.095  0.92392    
collision:net_tot:CDS -100.47185 1051.24998  -0.096  0.92386    
---
...
Residual deviance: 35718  on 11364693  degrees of freedom
...
Coefficients:
              Estimate Std. Error  z value Pr(>|z|)    
(Intercept) -9.2308006  0.0381851 -241.739  < 2e-16 ***
ref.typeG/C  1.0150544  0.0480090   21.143  < 2e-16 ***
collision    0.0021228  0.0228557    0.093  0.92600    
net_tot     -0.0060020  0.0256829   -0.234  0.81522    
CDS          0.0003565  0.0224728    0.016  0.98734    
rep.ratio   -0.0741196  0.0250862   -2.955  0.00313 ** 
rep.strand   0.0688170  0.0241633    2.848  0.00440 ** 
net_tot:CDS  0.0232700  0.0151645    1.535  0.12491    
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
Coefficients:
            Estimate Std. Error z value Pr(>|z|)    
(Intercept)  -9.9260     0.7571 -13.111   <2e-16 ***
ref.typeG/C   1.1879     0.6903   1.721   0.0853 .  
collision     0.2460     0.3094   0.795   0.4266    
net_tot       0.4526     0.2537   1.784   0.0744 .  
rep.ratio     0.3618     0.3590   1.008   0.3135    
rep.strand    0.5368     0.4293   1.250   0.2112    
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

(Dispersion parameter for binomial family taken to be 1)

    Null deviance: 192.83  on 56626  degrees of freedom
Residual deviance: 183.33  on 56621  degrees of freedom
...
Coefficients:
             Estimate Std. Error  z value Pr(>|z|)    
(Intercept) -9.230009   0.038263 -241.228  < 2e-16 ***
ref.typeG/C  1.014214   0.048128   21.073  < 2e-16 ***
collision   -0.000623   0.023003   -0.027  0.97839    
net_tot     -0.007069   0.025578   -0.276  0.78227    
rep.ratio   -0.076430   0.025157   -3.038  0.00238 ** 
rep.strand   0.066006   0.024221    2.725  0.00643 ** 
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

(Dispersion parameter for binomial family taken to be 1)

    Null deviance: 36026  on 11308076  degrees of freedom
Residual deviance: 35537  on 11308071  degrees of freedom
  (705944 observations deleted due to missingness)
AIC: 35549
