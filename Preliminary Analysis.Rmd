...
Update: There was a discrepancy in files because the SGD people realigned the reads to the updated version of the yeast genome which changed some of the data.
...
Time for the Van Djik data. This data is about XUTs
